                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto">
                        ...
                        <NavDropdown title="My Account" id="basic-nav-dropdown">
                            ...
                            <NavDropdown.Divider />
                            <NavDropdown.Item href="#action/3.2">{this.props.browserState.firstName + " " + this.props.browserState.lastName}</NavDropdown.Item>
                        </NavDropdown>
                    </Nav>
                    <Form inline>
                        <FormControl type="text" placeholder="Search" className="mr-sm-2" id="search"/>
                        <Button variant="outline-success" className="mr-sm-2" onClick={this.doSearch}>Search</Button>
